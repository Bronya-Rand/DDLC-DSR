...
label ch5_main:
    ...
    scene bg club_day at dynamic_super_resolution(read_image_size("bg/class.png")) with wipeleft_scene
    ...
    scene bg corridor at dynamic_super_resolution(read_image_size("bg/corridor.png")) with wipeleft
    "I quickly leave the classroom."
    m "Don't strain yourself~"
    "Monika calls that out after me."
    "I quicken my pace."

    scene bg residential_day at dynamic_super_resolution(read_image_size("bg/residential.png")) with wipeleft_scene
    "What was I thinking?"
    ...
    scene bg house at dynamic_super_resolution(read_image_size("bg/house.png")) with wipeleft
