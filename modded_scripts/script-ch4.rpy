label ch4_main:
    ...
    stop music fadeout 2.0
    scene bg house at dynamic_super_resolution(read_image_size("bg/house.png"))
    with wipeleft_scene
    ...
    scene bg sayori_bedroom with wipeleft at dynamic_super_resolution(read_image_size("bg/sayori_bedroom.png"))
    mc "Sayori?"
    play music t10
    ...
    scene bg sayori_bedroom at dynamic_super_resolution(read_image_size("bg/sayori_bedroom.png"))
...
label ch4_exclusive_natsuki:
    ...
    scene bg house at dynamic_super_resolution(read_image_size("bg/house.png")) with wipeleft_scene
    ...
    scene bg kitchen at dynamic_super_resolution(read_image_size("bg/kitchen.png"))
    ...
    n "Eh?!"
    scene bg kitchen at dynamic_super_resolution(read_image_size("bg/kitchen.png")) with dissolve_cg
    ...
    scene bg kitchen at dynamic_super_resolution(read_image_size("bg/kitchen.png")) with wipeleft_scene
...
label ch4_exclusive_yuri:
    ...
    scene bg bedroom at dynamic_super_resolution(read_image_size("bg/bedroom.png")) with wipeleft
    ...
    scene bg bedroom at dynamic_super_resolution(read_image_size("bg/bedroom.png")) with wipeleft_scene
    ...
    mc "I-It's fine..."
    scene bedroom at dynamic_super_resolution(read_image_size("bg/bedroom.png")) with dissolve_cg
    ...
    scene bedroom at dynamic_super_resolution(read_image_size("bg/bedroom.png")) with wipeleft_scene
