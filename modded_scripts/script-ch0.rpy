label ch0_main:
    ...
    scene bg residential_day at dynamic_super_resolution(read_image_size("bg/residential.png"))
    ...
    s "Hey! Wait Up!!"
    "This is a sample of the longest text I can come up with to test and troubleshoot this history thing as to why it keeps cutting regular dialogue in the box. IDK why. Off on a tangent again."
    ...
    scene bg class_day at dynamic_super_resolution(read_image_size("bg/class.png"))
    with wipeleft_scene
    ...
    scene bg corridor at dynamic_super_resolution(read_image_size("bg/corridor.png"))
    with wipeleft_scene
    ...
    scene bg club_day at dynamic_super_resolution(read_image_size("bg/class.png"))
    with wipeleft
    play music t3
